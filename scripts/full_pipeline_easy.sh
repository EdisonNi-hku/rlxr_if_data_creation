...
# Base repo names
AUGMENT_REPO_NAME_BASE="magpie_creative_easy_dedup_augmented_${SPLIT}_${VERSION}"
FILTER_REPO_NAME_BASE="magpie_creative_easy_dedup_filtered_${SPLIT}_${VERSION}"
CHECKLIST_REPO_NAME_BASE="magpie_creative_easy_dedup_checklist_${SPLIT}_${VERSION}"
